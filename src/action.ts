...
new LearnableAction(3, "Hefty Punch", 1, 0, new OffsetPointsEffect(
    "health", true, new PowerPointsOffset(-5),
));
new LearnableAction(4, "Potent Punch", 1, 0, new OffsetPointsEffect(
    "health", true, new PowerPointsOffset(-7),
));
new LearnableAction(5, "Fierce Punch", 1, 0, new OffsetPointsEffect(
...
new LearnableAction(7, "Fervent Pummel", 1, 0, new ChanceEffect(0.65,
...
new LearnableAction(9, "Enraged Clobber", 1, 0, new ChanceEffect(0.3,
...
new LearnableAction(11, "Noxious Poison", 1, 0, new LingerEffect(3,
    new OffsetPointsEffect("health", true, new PowerPointsOffset(-3)),
));
new LearnableAction(12, "Biohazard", 1, 0, new LingerEffect(6,
    new OffsetPointsEffect("health", true, new PowerPointsOffset(-1)),
));
new LearnableAction(13, "Corroding Biohazard", 1, 0, new LingerEffect(6,
    new OffsetPointsEffect("health", true, new PowerPointsOffset(-2)),
));

// Health leech actions.
new LearnableAction(14, "Leech", 1, 0, new TransferPointsEffect(
    "health", true, 0.5, new PowerPointsOffset(-3.5),
));
new LearnableAction(15, "Ravenous Leech", 1, 0, new TransferPointsEffect(
    "health", true, 0.5, new PowerPointsOffset(-6),
));
new LearnableAction(16, "Siphon", 1, 0, new TransferPointsEffect(
    "health", true, 0.8, new PowerPointsOffset(-2.5),
));
new LearnableAction(17, "Wide Siphon", 1, 0, new TransferPointsEffect(
    "health", true, 0.8, new PowerPointsOffset(-5),
));
...
new LearnableAction(19, "Dashing Kick", 1, 0, new OffsetPointsEffect(
...
new LearnableAction(23, "Gamma Radiation", 1, 0, new LingerEffect(6,
    new OffsetPointsEffect("health", true, new RatioPointsOffset(-0.03)),
));

// Health regen actions.
new LearnableAction(24, "Rest", 1, 0, new OffsetPointsEffect(
    "health", false, new RatioPointsOffset(0.15),
));
new LearnableAction(25, "Mindful Rest", 1, 0, new OffsetPointsEffect(
    "health", false, new RatioPointsOffset(0.30),
));
new LearnableAction(26, "Mend", 1, 0, new ChanceEffect(0.65,
...
new LearnableAction(28, "Soothe", 1, 0, new LingerEffect(3,
    new OffsetPointsEffect("health", false, new RatioPointsOffset(0.06)),
));
new LearnableAction(29, "Gentle Soothe", 1, 0, new LingerEffect(6,
...
new LearnableAction(31, "Frantic Stress", 1, 0, new OffsetPointsEffect(
    "energy", true, new AbsolutePointsOffset(-4),
));
new LearnableAction(32, "Bewilder", 1, 0, new ChanceEffect(0.5,
...
new LearnableAction(36, "Galvanize", 1, 0, new ChanceEffect(0.5,
...
new LearnableAction(39, "Grand Fortify", 1, 0, new OffsetPointsEffect(
...
new LearnableAction(41, "Sturdy Shield", 1, 0, new BurstPointsEffect(
...
new LearnableAction(44, "Crafty Equip", 1, 0, new OffsetPointsEffect(
...
new LearnableAction(46, "Razor Sharpen", 1, 0, new BurstPointsEffect(
...
new LearnableAction(48, "Contra Revert", 1, 0, new SetPointsEffect(
    "damage", true, pointConstants.startDamage,
));
new LearnableAction(49, "Auto Revert", 1, 0, new SetPointsEffect(
    "damage", false, pointConstants.startDamage,
));
new LearnableAction(50, "Heist", 1, 0, new TransferPointsEffect(
    "damage", true, 1, new AbsolutePointsOffset(-1),
));
new LearnableAction(51, "Switcharoo", 1, 0, new SwapPointsEffect("damage"));
...
new LearnableAction(56, "Nullify", 1, 0, new ClearStatusEffect(null, true, null));
new LearnableAction(57, "Purify", 1, 0, new ClearStatusEffect(null, false, null));
new LearnableAction(58, "Damper", 1, 0, new ClearStatusEffect(null, true, 1));
new LearnableAction(59, "Rejuvinate", 1, 0, new ClearStatusEffect(null, false, -1));
...
new LearnableAction(64, "Curling Bash", 1, 0, new CompositeEffect([
...
new LearnableAction(67, "Gambling High", 1, 0, new ChanceEffect(0.65,
    new OffsetPointsEffect("energy", false, new AbsolutePointsOffset(4)),
...
new LearnableAction(70, "Stepping Stone", 1, 0, new CompositeEffect([
...
new LearnableAction(72, "Charcoal Strike", 1, 0, new CompositeEffect([
...
new LearnableAction(74, "Bleach", 1, 0, new CompositeEffect([
    new OffsetPointsEffect("damage", false, new AbsolutePointsOffset(2)),
